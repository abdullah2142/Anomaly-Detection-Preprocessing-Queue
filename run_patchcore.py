...
OUTPUT_FILE = "results/patchcore_final.csv"
PARTIAL_FILE = "results/patchcore_partial.csv"
...
for category in CATEGORIES:
    for seed in SEEDS:
        ...
        try:
            ...
            all_results.append({"model": "PatchCore", "category": category, "seed": seed, "phase": "baseline", "ctype": "clean", "severity": "none", "rescue": "none", "image_AUROC": clean_auroc})
            save_results() # Rule 1: Save after every run
