...
OUTPUT_FILE = "results/padim_augmented.csv"
PARTIAL_FILE = "results/padim_augmented_partial.csv"
...
class AugmentedTrainDataset(Dataset):
    ...
    images so PaDiM's multivariate Gaussians are fitted on both clean and
    degraded feature distributions — simulating unknown real-world degradation."""
